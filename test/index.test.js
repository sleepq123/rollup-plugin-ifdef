...
function mockPlugin(src, option) {
  return plugin(option).transform(src);
}
...
test("IFDEBUG true", () => {
  testOne(
    "cases/IFDEBUG.js",
    { isDebug: true },
    /font-size:13px[\s\S]+this.ruleData/
  );
});
